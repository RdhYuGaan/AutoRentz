...
const CarDetails = ({ isOpen,classModel, car}:
  CarDetailsProps) => {
      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        onClose={classModel}>
          ...
          <div className='fixed inset-0 overflow-y-auto'>
            ...
            enter="ease-out duration-300"
            enterFrom="opacity-0"
            enterTo="opasity-100 scale-100"
            leave="ease-in duration-200"
            leaveFrom="opasity-100 scale-100"
                ...
                <div className='flex-1 flex flex-col gap-3'>
                  <div className='relative w-full h-40 bg-pattern bg-cover
                   bg-center rounded-lg'>
                     <Image src={generateCarImageUrl(car,'28')} alt='car model' fill priority 
                     className='object-contain' />
